    ...
    <header className="flex h-[64px] shrink-0 items-center gap-4 border-b border-border bg-card px-4" role="banner">
      ...
      <div className="ml-auto flex shrink-0 items-center gap-2">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <button
              className="flex h-10 items-center gap-2 rounded-md bg-primary pr-2.5 pl-1.5 text-primary-foreground transition-colors hover:bg-primary-hover"
              aria-label="Facility"
            >
              ...
              <span className="hidden max-w-36 truncate text-[13px] font-medium sm:block">{user.facilityName}</span>
          ...
          <DropdownMenuContent align="end" className="w-56">
            <DropdownMenuLabel className="font-normal">
              <div className="flex flex-col gap-0.5">
                <p className="text-sm font-semibold">{user.facilityName}</p>
                <p className="text-xs text-muted-foreground">{user.facilityCode}</p>
              </div>
            </DropdownMenuLabel>
            <DropdownMenuSeparator />
